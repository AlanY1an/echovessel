...
```bash
uv run pytest tests/ -q                # 839 测试 · 覆盖 memory / runtime / voice / proactive / channels / import / integration
...
- ✅ **Daemon**:完整 boot · 所有启动接线都在 log 里可验证 · 839 测试通过(10 skipped)
...
- ✅ 839 测试通过(10 skipped)· 分层 import 契约被强制 · 4/4 MVP eval 指标达标
